...
class GetPersonalizedRankingCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, GetPersonalizedRankingCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.serializeAws_restJson1GetPersonalizedRankingCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.deserializeAws_restJson1GetPersonalizedRankingCommand)(output, context);
    }
}
